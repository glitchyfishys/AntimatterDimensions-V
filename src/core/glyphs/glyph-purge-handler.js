...
export const GlyphSacrificeHandler = {
  ...
  get maxSacrificeForEffects() {
    return Math.min(1e100 * GlitchRealityUpgrades.all[1].effectOrDefault(new Decimal(1)).toNumber(), 1e300);
    },
  ...
  glyphSacrificeGain(glyph) {
    ...
    return Math.clampMin(Math.pow(pre10kFactor * post10kFactor * glyph.strength *
