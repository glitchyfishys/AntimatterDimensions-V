...
export const glitchRealityUpgrades = [
  ...
  },
  {
    ...
    id: 14,
    cost: 1e175,
    requirement: () => `reach ${"1e2E15"} antimatter with Effarig Reality, Nameless one's dim limit and low tachyon gain, V's Reality, and Lai'tela's Reality (also reqires ${GlitchRealityUpgrades.all[12].name})`,
  ...
  },
  {
    ...
    requirement: () => `reach ${"1e500E15"} antimatter (also reqires ${GlitchRealityUpgrades.all[13].name})`,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    description: "glitch stays compleate past Pelle and unlock glitch second layer also AD are powered by 2.25",
    effect: () =>  1.25,
    formatEffect: value => (GlitchRealityUpgrades.all[15].isBought ? "unlocked" : "locked" + ", ^2.25 AD")
  },
];
