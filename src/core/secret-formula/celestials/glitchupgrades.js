...
export const glitchRealityUpgrades = [
  ...
  },
  {
    ...
    requirement: () => `reach ${"1e500E15"} antimatter (also reqires the ${GlitchRealityUpgrades.all[13].name})`,
  ...
  },
  {
    ...
    requirement: () => `reach ${"1e25E15"} antimatter all effects excluding ra's and nameless one's reality (also reqires the ${GlitchRealityUpgrades.all[14].name})`,
