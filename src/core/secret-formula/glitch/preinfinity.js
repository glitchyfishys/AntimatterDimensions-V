...
export const preinfinityUG = [
  {
    name: "dimless",
    id: 0,
    requirement: () => `reach ${format(1e15)} antimater without any dimboosts, no galaxies`,
  ...
  name: "dimatonal limits",
    id: 1,
    requirement: () => `have ${format(1e25)} antimatter with only one dimboost, no galaxies`,
  ...
  name: "vector 2",
    id: 2,
    requirement: () => `have ${format(1e35)} antimatter with upto two dimboosts, no galaxies`,
  ...
  },
  {
    ...
    id: 3,
    requirement: () => `have ${format(1e150)} antimatter with upto six dimboosts, no galaxies`,
  ...
  },
  {
    ...
    id: 4,
    requirement: () => `have ${format(1e7)} antimatter with no dimboosts, one galaxy, up to ten 2nd dimentsions`,
    ...
    checkevent: GAME_EVENT.GAME_TICK_BEFORE,
    description: "additonal tickspeed prechases by their amount",
  ...
  },
  {
    ...
    id: 5,
    requirement: () => `have ${format(1e25)} antimatter with no dimboosts, one galaxy, up to 20 4st dimentsions`,
  ...
  },
  {
    ...
    id: 7,
    requirement: () => `have ${format(3)} antimatter galaxys without infinity broken`,
