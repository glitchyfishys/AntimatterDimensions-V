...
export const ecTimeStudies = [
  ...
  },
  {
    id: 4,
    cost: 70,
    requirement: [143, () => (realityUGs.all[3].effectOrDefault(0) == 1 && player.timestudy.studies.includes(141)), () => (realityUGs.all[3].effectOrDefault(0) == 1 && player.timestudy.studies.includes(142))],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    secondary: {
      resource: "Infinities",
  ...
  },
  {
    id: 8,
    cost: 115,
    requirement: [123, () => (realityUGs.all[3].effectOrDefault(0) == 1 && player.timestudy.studies.includes(121)), () => (realityUGs.all[3].effectOrDefault(0) == 1 && player.timestudy.studies.includes(122))],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    secondary: {
