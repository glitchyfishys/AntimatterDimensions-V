...
export default {
  ...
  methods: {
    update() {
      ...
      this.achCountdown = Decimal.div((Achievements.timeToNextAutoAchieve), gameSpeedupFactor);
      this.totalCountdown = Decimal.div(((Achievements.preReality.countWhere(a => !a.isUnlocked) - 1) * Achievements.period +
