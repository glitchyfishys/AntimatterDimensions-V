...
export default {
  ...
  methods: {
    update() {
      ...
      this.totalCountdown = Decimal.div(((Achievements.preReality.countWhere(a => !a.isUnlocked) - 1) * Achievements.period.toNumber() + Achievements.timeToNextAutoAchieve), gameSpeedupFactor);
