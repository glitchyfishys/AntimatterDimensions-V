  ...
  methods: {
    ...
    ECc(){
      ...
      for(let i=1; i <= 12; i++){
       ...
       h++ == 13 ?  GameUI.notify.eternity("All EC's are completed",5000) : GameUI.notify.eternity("full completed EC's up to " + h + "<br> next at " + format( new Decimal(this.ECreq[h++])) + " EP",5000);
    },
  }
}
</script>
